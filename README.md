# DedicatedVPN – сайт-визитка

## Описание
DedicatedVPN – это статический сайт-визитка, предназначенный для представления VPN-сервиса. Он содержит информацию о сервисе, политику конфиденциальности, обработку персональных данных и условия возврата.
